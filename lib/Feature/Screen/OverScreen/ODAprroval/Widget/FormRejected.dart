...
class FormRejected extends StatefulWidget {
  const FormRejected({super.key});

  @override
  State<FormRejected> createState() => _FormRejectedState();
}

class _FormRejectedState extends State<FormRejected> {
  bool reject = false;
  bool accept = false;
  ...
  Widget build(BuildContext context) {
    final rejectedForms = fetchform.where((form) => form['response'] == 'Rejected').toList();
